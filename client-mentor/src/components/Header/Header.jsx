...
const Header = () => {
  ...
  return (
    <header className="sticky top-0 left-0 w-full z-50 flex flex-wrap justify-between items-center py-4 px-6 bg-gray-900 text-white shadow-lg border-b-4 border-gray-800">
      {/* Logo Section */}
      <div
      ...
      >
        <ul className="flex flex-col md:flex-row items-center space-y-2 md:space-y-0 md:space-x-4">
          {contactOptions.map((option, index) => (
            <li
              key={index}
              className="flex flex-col md:flex-row items-center md:items-start text-sm text-white gap-2"
            >
